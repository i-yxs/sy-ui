...
<script>
    export default {
        ...
        methods: {
             ...
             * 绘制图片前触发
             */
            handleDrawbefore({ dpr, width, height, image, source, context2d, location, imageInfo }) {
                /**
                 * 绘制圆角图片
                 */
             ...
             * 绘制图片后触发
             */
            handleDrawafter({ dpr, width, height, image, source, context2d, location, imageInfo }) {
                // 只有是相机拍摄的才绘制水印
                if (source === 'camera') {
                    /**
                     * 绘制时间水印
